package com.pogonet.course.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.pogonet.course";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/springapp-model"),
        mapper("/springapp-dao"),
        mapperxml("/springapp-web"),
